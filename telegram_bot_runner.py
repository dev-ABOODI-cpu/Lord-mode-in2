...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        "👋 مرحباً! أنا بوت يعمل على  𝙻𝙾𝚁𝙳 𝙷𝙾𝚂𝚃\n\n"
        "الأوامر المتاحة:\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        "📚 المساعدة:\n\n"
        "هذا البوت يعمل بشكل مستمر على خادم  𝙻𝙾𝚁𝙳 𝙷𝙾𝚂𝚃\n"
...
def run_bot(token: str, bot_name: str) -> None:
    try:
        print("\n" + "═"*60)
        print(f" 🤖  𝙻𝙾𝚁𝙳 𝙷𝙾𝚂𝚃 - جاري تشغيل البوت: {bot_name}")
        ...
        print(f" ✅ البوت {bot_name} جاهز الآن على  𝙻𝙾𝚁𝙳 𝙼𝙾𝙳𝙴!")
